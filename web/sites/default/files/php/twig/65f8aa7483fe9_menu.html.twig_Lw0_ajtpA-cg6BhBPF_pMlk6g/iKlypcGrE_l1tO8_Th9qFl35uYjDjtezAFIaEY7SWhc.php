...
/* themes/custom/silver/templates/navigation/menu.html.twig */
class __TwigTemplate_d2ef03190ce1d714ea8ddad5062c88d7 extends Template
{
    private $source;
    private $macros = [];
...
";
            ...
            <div class=\"dropdown-menu rounded-0 m-0\">
              ";
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["subitem"]) {
                            // line 39
                            echo "                ";
                            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getLink($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["subitem"], "title", [], "any", false, false, true, 39), 39, $this->source), $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["subitem"], "url", [], "any", false, false, true, 39), 39, $this->source), ["class" => ["dropdown-item"]]), "html", null, true);
                            echo "
              ";
                        }
  ...
  ";
    ...
    {
        return "themes/custom/silver/templates/navigation/menu.html.twig";
    }
    ...
    {
        return array (  122 => 46,  116 => 45,  110 => 43,  106 => 41,  97 => 39,  93 => 38,  86 => 36,  83 => 35,  80 => 34,  76 => 33,  73 => 32,  70 => 31,  67 => 30,  52 => 29,  44 => 27,  41 => 22,  39 => 21,);
    }
...
{% macro menu_links(items, attributes, menu_level) %}
      ...
      {% for item in items %}
        {% if item.below %}
          <div class=\"nav-item dropdown\">
            <a href={{ item.url }} class=\"nav-link dropdown-toggle\" data-bs-toggle=\"dropdown\">{{ item.title }}</a>
            <div class=\"dropdown-menu rounded-0 m-0\">
  ...
  {% endif %}
{% endmacro %}", "themes/custom/silver/templates/navigation/menu.html.twig", "/var/www/html/web/themes/custom/silver/templates/navigation/menu.html.twig");
    }
