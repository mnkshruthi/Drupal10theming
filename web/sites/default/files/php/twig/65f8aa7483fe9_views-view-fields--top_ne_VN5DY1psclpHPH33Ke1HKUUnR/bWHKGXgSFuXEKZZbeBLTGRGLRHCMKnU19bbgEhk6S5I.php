...
class __TwigTemplate_e9625a484db37137586d72fb1dfa8a0c extends Template
{
  ...
  <div class=\"d-flex align-items-center bg-light px-3 \">
      <a class=\"text-secondary-emphasis font-weight-semi-bold\" ";
        // line 37
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", ["text-decoration-none"], "method", false, false, true, 37), 37, $this->source), "html", null, true);
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["fields", "attributes"]);    }
...
<div class=\"d-flex text-decoration-none \">
  ...
  <div class=\"d-flex align-items-center bg-light px-3 \">
      <a class=\"text-secondary-emphasis font-weight-semi-bold\" {{ attributes.addClass('text-decoration-none') }}href=\"index.html\">{{ fields.title.content }}</a>
  </div>
</div>
